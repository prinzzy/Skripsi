                                ...
                                <div class="modal-body">
                                    <form action="{{ route('students.update') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="id" class="form-control" id="siswa-{{ $student->id }}" value="{{ $student->id }}" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_orangtua" class="form-control" id="nama_orangtua-{{ $student->id }}" value="{{ $student->nama_orangtua }}" required>
                                        </div>
                                        <div class="mb-3">
